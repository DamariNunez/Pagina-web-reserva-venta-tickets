            ...
            <header class="ova_header ovatheme_header_v1  bg_heading fixed has_logo_scroll has_logo_mobile">
                ...
                <div class="ova-bg-heading" style="background-image: url( https://ovatheme.com/em4u/wp-content/themes/em4u/assets/img/bg_heading-compressor.jpg ); ">
                    ...
                    <div class="container ova-breadcrumbs">
                        <h1 class="ova_title">{{ __('Register') }}</h1>
                        <div id="breadcrumbs" >
                            <div class="breadcrumbs">
                                <div class="breadcrumbs-pattern">
                                    <div class="container">
                                        <div class="row">
                                            <ul class="breadcrumb"><li><a href="https://ovatheme.com/em4u/">{{ __('Home') }}</a></li>  <li>{{ __('Register') }}</li></ul>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="wpb_wrapper">
                                                    <div class="ova-login-form-container">
                                                        ...
                                                        <div class="login-form-container">
                                                            ...
                                                            <form name="registerform" id="loginform" method="POST" action="{{ route('register') }}">
                                                                @csrf
                                                                <!-- Name -->
                                                                <p class="register-username">
                                                                    <x-input-label for="username" :value="__('Name')" />
                                                                    <x-text-input type="username" name="username" id="user_login" autocomplete="" class="input"/>
                                                                    <x-input-error :messages="$errors->get('username')" class="mt-2" />
                                                                </p>
                                                                <!-- Last Name -->
                                                                <p class="login-username">
                                                                    <x-input-label for="lastname" :value="__('Last name')" />
                                                                    <x-text-input type="lastname" name="lastname" id="user_login" autocomplete="" class="input"/>
                                                                ...
                                                                <p class="login-username">
                                                                    ...
                                                                    <x-text-input type="phone" name="phone" id="user_login" autocomplete="" class="input"/>
                                                                ...
                                                                <p class="login-submit">
                                                                    <x-primary-button type="submit" name="wp-submit" id="wp-submit" class="button button-primary" value="Register">
                                                                            {{ __('Register') }}
                                                                        </x-primary-button>
                                                                </p>
                                                            </form>
